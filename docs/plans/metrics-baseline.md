...
| Runtime suite | 56 passed, 1 skipped | skip 为 macOS 本机无法运行 Linux Bubblewrap real smoke；CI 安装 Bubblewrap 后执行 |
| Runtime suite 本地耗时 | 1.25s | Python 3.11，本机定向运行；CI 门为 `<60s` |
